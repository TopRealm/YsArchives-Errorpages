...
# Guess Target
require_once __DIR__ . \DIRECTORY_SEPARATOR . '404_guessTarget.php';
?>
<!DOCTYPE html>
<html lang="zh">
...
<head>
    ...
    <title>HTTP 404 页面未找到 - 有兽档案馆，开放的有兽焉wiki</title>
    <style>
*{margin:0;padding:0}
...
<body>
    ...
    <main>
        <h1>
            页面未找到<em>（HTTP 404）</em><br>Not Found
        </h1>
        <p>
            很抱歉，我们未能找到您所访问的网址。<br>Sorry, the page you are looking for could not be found.
        </p>
        <p>
            您是否想要访问<a href="<?php echo getTarget()['encTarget']; ?>"><?php echo getTarget()['decTarget']; ?></a>？<br>
            Did you want to visit <a href="<?php echo getTarget()['encTarget']; ?>"><?php echo getTarget()['decTarget']; ?></a>?
        </p>
        <p>
