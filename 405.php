...
<head>
	...
	<title>不允许的方法 HTTP 405 Method Not
		Allowed – 求闻百科，共笔求闻</title>
	<style>
		* {
			margin: 0;
			padding: 0;
...
<body>
	...
	<main>
		<h1 class="title" id="http_405">
			不允许的方法 <em>HTTP 405 Method Not Allowed</em>
		</h1>
		<p>很抱歉，您访问此地址时使用了不被允许的方法。</p>
		<p>建议您更换请求方法，或者检查请求内容是否正确。</p>
